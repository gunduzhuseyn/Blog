...
urlpatterns = [
    ...
    path('400.html/', TemplateView(template_name='400.html'), name='400_error_page'),
    path('403.html/', TemplateView(template_name='403.html'), name='403_error_page'),
    path('404.html/', TemplateView(template_name='404.html'), name='404_error_page'),
    path('500.html/', TemplateView(template_name='500.html'), name='500_error_page'),
]
